...
Password: <input name="password" type="password" size="30" maxlength="100"><br>At least 8 alphanumeric characters, 1 uppercase letter, 1 lowercase letter and 1 @$!%*#?&-_ symbol<br><br>
Comfirm password: <input name="comfirm" type="password" size="30" maxlength="100"><br><br>
